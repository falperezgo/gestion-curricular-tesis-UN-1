...
class DirectorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create director" do
    assert_difference('Director.count') do
      post directors_url, params: { director: { email: @director.email, firstname: @director.firstname, identification: @director.identification, lastname: @director.lastname, phone: @director.phone } }
    end
  ...
  test "should update director" do
    patch director_url(@director), params: { director: { email: @director.email, firstname: @director.firstname, identification: @director.identification, lastname: @director.lastname, phone: @director.phone } }
