...
class AdministratorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create administrator" do
    assert_difference('Administrator.count') do
      post administrators_url, params: { administrator: { email: @administrator.email, firstname: @administrator.firstname, identification: @administrator.identification, lastname: @administrator.lastname, phone: @administrator.phone } }
    end
  ...
  test "should update administrator" do
    patch administrator_url(@administrator), params: { administrator: { email: @administrator.email, firstname: @administrator.firstname, identification: @administrator.identification, lastname: @administrator.lastname, phone: @administrator.phone } }
